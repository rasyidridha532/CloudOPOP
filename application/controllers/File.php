...
class File extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $config['total_rows'] = $this->M_file->total_rows($q);
        $file = $this->M_file->get_limit_data($config['per_page'], $start, $q);
    ...
    public function update_action() 
    {
		...
		'link' => $this->input->post('link',TRUE),
            ...
            $this->M_file->update($this->input->post('id_file', TRUE), $data);
...
/* Generated by Harviacode Codeigniter CRUD Generator 2020-07-02 05:20:24 */
/* http://harviacode.com */